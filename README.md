...
Reemplaza `src/assets/logo-wax.png` con tu propio archivo PNG (idealmente con fondo transparente).
...
- **Limitación:** los datos viven en un solo navegador / dispositivo.
...
- **Lucide** — iconos.
- **Fraunces + Figtree** — tipografías (Google Fonts).
